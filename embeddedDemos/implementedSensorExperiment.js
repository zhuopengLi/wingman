...
let choosenValues = ['/Users/hannes/documents/Repos/zhuopengli.github.io/xeokit-bim-viewer/embeddedDemos/AachenTerrain.json','/Users/hannes/documents/Repos/zhuopengli.github.io/xeokit-bim-viewer/embeddedDemos/AachenPipes.json']
...
setInterval(function(){ 
    ...
    for (var c = 0; c < 1; c++) {
        ...
        timestampValue = stringDate + " , " + realTime[7] + ":" + realTime[8] + ":" + realTime[9] ;
        ...
        // Do something with file
            ...
            MongoClient.connect(uri, function(err, db) {
                if (err) throw err;
                var dbo = db.db("Update");
                for (var b = 0; b < 5; b++) {
                var myquery = { id: ids[b] };
                
                // console.log(matrixAfterMQTT)
                var newvalues = {$set: {NoiseLevel: matrixAfterMQTT[b][5]}};
                dbo.collection("Hello").updateMany(myquery, newvalues, function(err, res) {
                  if (err) throw err;
                });
            ...
            //     var myobj = obj.metaObjects;
            //     // console.log(myobj);

            //     let collection = chooseCollection[c];
            //     dbo.collection("Hello").insertMany(myobj, function(err, res) {
            //     if (err) throw err;
